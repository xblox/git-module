 ...
 * @param where {string}
 * @param errorCB {function|null}
 * @param stdOutCB {function|null}
 */
    ...
    function (argv) {
        ...
        try {
            ...
            _.each(_modules, function (module) {
                ...
                var exec = doGitCommand(module,'pull',null,null,cwd,null);
                exec.then(function () {
                }, function (e) {
                    console.error(e);
                });
    ...
    function (argv) {
        ...
        try {
            ...
            _.each(_modules, function (module) {
                ...
                var gitPush = gitCommitFailed!==true && doGitCommand(module,"push",null,[""],cwd,null);
                all.push(gitCommit);
