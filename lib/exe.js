...
//console.log('argv',modules);
cli.command('init-modules', 'Init modules provided in package.json or package.js',
    function (yargs) {
        //console.log('init modules : ',modules.getModules(process.cwd()));
        ...
        if(!argv.help){
            ...
            //console.log('process modules  : ',_modules);
            ...
            _.each(_modules,function (module) {
                console.log('process module '+module.name + ' for : ',module);
                var gitp = new git({
